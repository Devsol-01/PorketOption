...
import 'package:mobile_app/ui/views/group_save/create_private_group_save_view.dart';
    ...
    try {
      ...
      if (response?.confirmed == true) {
        ...
        if (data == 'public') {
          ...
          _navigationService.navigateToView(const CreatePublicGroupSaveView());
        } else if (data == 'private') {
          print('Navigating to private group save form...');
          // Navigate to private group save form
          _navigationService.navigateToView(const CreatePrivateGroupSaveView());
        }
      }
    } catch (e) {
