...
import 'group_save_detail_viewmodel.dart';

class GroupSaveDetailView extends StackedView<GroupSaveDetailViewModel> {
  final Map<String, dynamic> group;
  
  const GroupSaveDetailView({super.key, required this.group});

  @override
  Widget builder(
    BuildContext context,
    GroupSaveDetailViewModel viewModel,
    Widget? child,
  ) {
    ...
    final memberCount = (group['memberCount'] as int?) ?? 1;
  ...
  Widget _buildGroupHeader(BuildContext context, GroupSaveDetailViewModel viewModel) {
  ...
  Widget _buildLeaderboardAndMembers(BuildContext context, GroupSaveDetailViewModel viewModel) {
    return Row(
      children: [
        Expanded(
  ...
  Widget _buildActionButtons(BuildContext context, GroupSaveDetailViewModel viewModel) {
    return Row(
      children: [
        Expanded(
          child: GestureDetector(
  ...
  Widget _buildGroupDetails(BuildContext context, GroupSaveDetailViewModel viewModel) {
  ...
  Widget _buildQuickLinks(BuildContext context, GroupSaveDetailViewModel viewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  Widget _buildLatestActivities(BuildContext context, GroupSaveDetailViewModel viewModel) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
  ...
  @override
  GroupSaveDetailViewModel viewModelBuilder(
    BuildContext context,
  ) =>
      GroupSaveDetailViewModel();
}
